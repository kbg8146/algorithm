![header](https://capsule-render.vercel.app/api?type=waving&color=0:4facfe,100:00f2fe&height=200&section=header&text=Algorithm&fontSize=50&fontColor=ffffff&animation=fadeIn&fontAlignY=40)
...
| 플랫폼 | 분류 |
|--------|------|
| **백준** | BFS/DFS, DP, 이분탐색, 백트래킹, 분할정복, 그리디, 정렬, 자료구조 |
